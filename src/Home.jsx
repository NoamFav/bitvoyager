              ...
              return (
                <div
                  ...
                  className={`
                    ...
                    ${isHovered ? "scale-105 shadow-xl shadow-cyan-900/30" : "shadow-lg shadow-gray-900/50"}
                    ${isBash ? "border border-cyan-500/30" : "border border-gray-700/30"}
                  `}
                ...
                >
                  {/* Background gradient */}
                  <div
                    className={`absolute inset-0 ${isBash ? "bg-gradient-to-br from-gray-800/90 via-gray-900 to-blue-900/30" : "bg-gradient-to-br from-gray-800/90 via-gray-900 to-gray-800"}`}
                  ></div>
                  ...
                  <div className="relative z-10 p-6">
                    <div className="flex items-start space-x-4">
                      ...
                      <div
                        className={`relative flex-shrink-0 p-3 rounded-lg ${isBash ? "bg-gradient-to-br from-blue-900/50 to-cyan-900/50" : "bg-gray-800/50"}`}
                      >
                        <img
                          src={
                            lang === "Bash"
                      ...
                      <div className="flex flex-col">
                        <h2
                          className={`text-xl font-bold mb-1 ${isBash ? "text-cyan-400" : "text-gray-300"}`}
                        >
                          {lang}
                        </h2>
                    ...
                    {/* Status indicator */}
                    <div
                      className={`mt-5 flex items-center justify-between ${isBash ? "" : "opacity-60"}`}
                    >
                      <span
                        className={`text-xs uppercase tracking-wide ${isBash ? "text-cyan-400" : "text-gray-500"}`}
                      >
                        {isBash ? "Available Now" : "Coming Soon"}
                      </span>
            ...
            {[
              ...
              <div
                ...
                className={`
                  ...
                  ${hoveredTeacher === teacher.name ? "scale-105 shadow-xl shadow-purple-900/30" : "shadow-lg shadow-gray-900/50"}
                `}
